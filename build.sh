...
curl $CURL_OPTS -o beauty_catalog.db https://github.com/seung602/Info/raw/main/beauty_catalog.db

echo "📥 daiy-trend-bot 레포에서 beauty_trends.db 다운로드 중..."
curl $CURL_OPTS -o beauty_trends.db https://github.com/seung602/daiy-trend-bot/raw/main/beauty_trends.db
